...
public class SAXParserHandler extends DefaultHandler {
    ...
    static {
        try {
            ...
            pstmt = conn.prepareStatement("INSERT INTO PaperInfo ("
                        + "title, author, journal, published_year, paper_url) VALUES ( ?, ?, ?, ?, ?)");  
    ...
    // Iterate the start element of XML
    @Override
    ...
    // Iterate the ending element of XML
    @Override  
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if(qName.equals("dblp")){
            ...
            try {
            	...
            	if (str != null && (str.equals("ACM Trans. Interact. Intell. Syst.") // TIIS
            		|| str.equals("ACM Trans. Intell. Syst. Technol.") // TIST
        			|| str.equals("ACM Trans. Knowl. Discov. Data") // TKDD
        			|| str.equals("ACM Trans. Inf. Syst.") // TOIS
        			|| str.equals("ACM Trans. Internet Techn.") // TOIT
        			|| str.equals("ACM Trans. Web"))) // TWEB
            								{
